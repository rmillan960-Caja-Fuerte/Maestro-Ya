...
export function useCollection<T = any>(
  ...
  useEffect(() => {
    if (memoizedTargetRefOrQuery && !memoizedTargetRefOrQuery.__memo) {
      throw new Error('Query or collection reference was not properly memoized using useMemoFirebase. This can cause severe performance issues.');
    }
    ...
    if (!path || path.includes('undefined')) {
        setData(null);
        setIsLoading(false);
        setError(null); // Not a real error, just waiting for a valid query
        return;
    }
